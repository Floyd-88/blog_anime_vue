        ...
        <table class="table-fixed border-x border-b">
          ...
          <tbody>
            <tr class="odd:bg-gray-100 hover:!bg-stone-200">
              <td class="p-2 border-b border-l text-center align-baseline">1</td>
              <td class="p-2 border-b border-l text-left">
                <div class="flex">
                  <div class="mr-2">
                    <img src="https://cdn.myanimelist.net/images/anime/4/19644t.jpg" alt="ava" />
                  </div>
                  <div>
                    ...
                    <div>
                      <div class="text-sm"><span>TV </span><span>(64 eps)</span></div>
                      <div class="text-sm"><span>Apr 2009</span>-<span>Jul 2010</span></div>
              ...
              <td class="py-2 px-4 border-b border-l text-center">
                <div class="flex items-center">
                  ...
                  <span class="font-bold text-2xl">9.10</span>
                </div>
              </td>
            </tr>
            <tr class="odd:bg-gray-100 hover:!bg-stone-200">
